...
class StoryMode {
    ...
    startChapter(index) {
        ...
        switch (index) {
            case 0: // الفصل الأول: يوم عادي
                ...
                this.showDialogue([
                    { speaker: 'الراوي', text: 'غوط الشعال... حومتنا. هني كبرنا، وهني كانت أحلى أيامنا.' },
    ...
    completeChapter() {
        ...
        const outros = [
            ...
            [{ speaker: 'نورالدين', text: 'خسرت... قدام شلة عيال حومة؟!' },
             { speaker: hero, text: 'مش عيال حومة بس... إحنا خوة. وهذا الفرق اللي عمرك ما باش تفهمه.' }]
        ];
